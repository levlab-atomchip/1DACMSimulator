...
class parameters(HasTraits): #provide general AMO constants
    c = Float(2.99792458*10**8) #m/s
    mu_0 = Float(4*pi*10**-7) #N/A^2
    h = hbar*2*pi #Js
    e = Float(1.602176487*10**-19) #C
    mu_b = Float(9.27400915*10**-24) #J/T
    m_e = Float(9.10938215*10**-31) #kg
    a_0 = Float(0.52917720859*10**-10) #m Bohr Radius
    a_s = Float(5.2*10**(-9)) #m scattering length
    k_b = Float(1.3806504*10**-23) #J/K
    m_Rb87 = Float(1.443160648*10**-25) #kg
